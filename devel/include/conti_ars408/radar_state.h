// Generated by gencpp from file conti_ars408/radar_state.msg
// DO NOT EDIT!


#ifndef CONTI_ARS408_MESSAGE_RADAR_STATE_H
#define CONTI_ARS408_MESSAGE_RADAR_STATE_H
...
struct radar_state_
{
  ...
  typedef boost::shared_ptr< ::conti_ars408::radar_state_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::conti_ars408::radar_state_<ContainerAllocator> const> ConstPtr;

}; // struct radar_state_

typedef ::conti_ars408::radar_state_<std::allocator<void> > radar_state;

typedef boost::shared_ptr< ::conti_ars408::radar_state > radar_statePtr;
typedef boost::shared_ptr< ::conti_ars408::radar_state const> radar_stateConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::conti_ars408::radar_state_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::conti_ars408::radar_state_<ContainerAllocator> >::stream(s, "", v);
return s;
}


template<typename ContainerAllocator1, typename ContainerAllocator2>
bool operator==(const ::conti_ars408::radar_state_<ContainerAllocator1> & lhs, const ::conti_ars408::radar_state_<ContainerAllocator2> & rhs)
{
...
template <class ContainerAllocator>
struct IsMessage< ::conti_ars408::radar_state_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::conti_ars408::radar_state_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::conti_ars408::radar_state_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::conti_ars408::radar_state_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::conti_ars408::radar_state_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::conti_ars408::radar_state_<ContainerAllocator> const>
  : FalseType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::conti_ars408::radar_state_<ContainerAllocator> >
{
  ...
  static const char* value(const ::conti_ars408::radar_state_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0x009d15dd11f0e873ULL;
  static const uint64_t static_value2 = 0x06d45f2901569726ULL;
};

template<class ContainerAllocator>
struct DataType< ::conti_ars408::radar_state_<ContainerAllocator> >
{
  static const char* value()
  {
...
template<class ContainerAllocator>
struct Definition< ::conti_ars408::radar_state_<ContainerAllocator> >
{
  static const char* value()
  {
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::conti_ars408::radar_state_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::conti_ars408::radar_state_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::conti_ars408::radar_state_<ContainerAllocator>& v)
  {
    s << indent << "ReadStatus: ";
...
#endif // CONTI_ARS408_MESSAGE_RADAR_STATE_H
