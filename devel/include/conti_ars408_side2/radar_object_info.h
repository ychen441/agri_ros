// Generated by gencpp from file conti_ars408_side2/radar_object_info.msg
// DO NOT EDIT!


#ifndef CONTI_ARS408_SIDE2_MESSAGE_RADAR_OBJECT_INFO_H
#define CONTI_ARS408_SIDE2_MESSAGE_RADAR_OBJECT_INFO_H
...
struct radar_object_info_
{
  ...
  typedef boost::shared_ptr< ::conti_ars408_side2::radar_object_info_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::conti_ars408_side2::radar_object_info_<ContainerAllocator> const> ConstPtr;

}; // struct radar_object_info_

typedef ::conti_ars408_side2::radar_object_info_<std::allocator<void> > radar_object_info;

typedef boost::shared_ptr< ::conti_ars408_side2::radar_object_info > radar_object_infoPtr;
typedef boost::shared_ptr< ::conti_ars408_side2::radar_object_info const> radar_object_infoConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::conti_ars408_side2::radar_object_info_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::conti_ars408_side2::radar_object_info_<ContainerAllocator> >::stream(s, "", v);
return s;
}


template<typename ContainerAllocator1, typename ContainerAllocator2>
bool operator==(const ::conti_ars408_side2::radar_object_info_<ContainerAllocator1> & lhs, const ::conti_ars408_side2::radar_object_info_<ContainerAllocator2> & rhs)
{
...
template <class ContainerAllocator>
struct IsMessage< ::conti_ars408_side2::radar_object_info_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::conti_ars408_side2::radar_object_info_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::conti_ars408_side2::radar_object_info_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::conti_ars408_side2::radar_object_info_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::conti_ars408_side2::radar_object_info_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::conti_ars408_side2::radar_object_info_<ContainerAllocator> const>
  : FalseType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::conti_ars408_side2::radar_object_info_<ContainerAllocator> >
{
  ...
  static const char* value(const ::conti_ars408_side2::radar_object_info_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0x599a292f7c5e980eULL;
  static const uint64_t static_value2 = 0x99c41704cbfb8d14ULL;
};

template<class ContainerAllocator>
struct DataType< ::conti_ars408_side2::radar_object_info_<ContainerAllocator> >
{
  static const char* value()
  {
...
template<class ContainerAllocator>
struct Definition< ::conti_ars408_side2::radar_object_info_<ContainerAllocator> >
{
  static const char* value()
  {
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::conti_ars408_side2::radar_object_info_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::conti_ars408_side2::radar_object_info_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::conti_ars408_side2::radar_object_info_<ContainerAllocator>& v)
  {
    s << indent << "ObjectID: ";
...
#endif // CONTI_ARS408_SIDE2_MESSAGE_RADAR_OBJECT_INFO_H
