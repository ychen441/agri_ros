...
"""autogenerated by genpy from conti_ars408_back2/radar_cluster.msg. Do not edit."""
import codecs
import sys
...
class radar_cluster(genpy.Message):
  ...
  _type = "conti_ars408_back2/radar_cluster"
...
float64 z"""
  ...
  _slot_types = ['std_msgs/Header','conti_ars408_back2/radar_cluster_info[]']
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        val1 = conti_ars408_back2.msg.radar_cluster_info()
        start = end
        end += 1
