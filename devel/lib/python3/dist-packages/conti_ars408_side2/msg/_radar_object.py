...
"""autogenerated by genpy from conti_ars408_side2/radar_object.msg. Do not edit."""
import codecs
import sys
...
"""
  ...
  _slot_types = ['std_msgs/Header','conti_ars408_side2/radar_object_info[]']
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        val1 = conti_ars408_side2.msg.radar_object_info()
        start = end
        end += 1
