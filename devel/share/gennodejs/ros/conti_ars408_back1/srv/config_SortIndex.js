...
class config_SortIndexRequest {
  ...
  static datatype() {
    ...
    return 'conti_ars408_back1/config_SortIndexRequest';
  }
...
class config_SortIndexResponse {
  ...
  static datatype() {
    // Returns string type for a service object
    return 'conti_ars408_back1/config_SortIndexResponse';
  }
...
module.exports = {
  ...
  datatype() { return 'conti_ars408_back1/config_SortIndex'; }
};
