...
// (in-package conti_ars408_side1.srv)
...
class config_RCSThresholdRequest {
  ...
  static datatype() {
    ...
    return 'conti_ars408_side1/config_RCSThresholdRequest';
  }
...
class config_RCSThresholdResponse {
  ...
  static datatype() {
    // Returns string type for a service object
    return 'conti_ars408_side1/config_RCSThresholdResponse';
  }
...
module.exports = {
  ...
  datatype() { return 'conti_ars408_side1/config_RCSThreshold'; }
};
