...
(cl:defmethod cl:initialize-instance :after ((m <radar_cluster_info>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'radar_cluster_info)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name conti_ars408_side1-msg:<radar_cluster_info> is deprecated: use conti_ars408_side1-msg:radar_cluster_info instead.")))

(cl:ensure-generic-function 'ClusterID-val :lambda-list '(m))
(cl:defmethod ClusterID-val ((m <radar_cluster_info>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader conti_ars408_side1-msg:ClusterID-val is deprecated.  Use conti_ars408_side1-msg:ClusterID instead.")
  (ClusterID m))

(cl:ensure-generic-function 'ClusterPosn-val :lambda-list '(m))
(cl:defmethod ClusterPosn-val ((m <radar_cluster_info>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader conti_ars408_side1-msg:ClusterPosn-val is deprecated.  Use conti_ars408_side1-msg:ClusterPosn instead.")
  (ClusterPosn m))

(cl:ensure-generic-function 'ClusterVrel-val :lambda-list '(m))
(cl:defmethod ClusterVrel-val ((m <radar_cluster_info>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader conti_ars408_side1-msg:ClusterVrel-val is deprecated.  Use conti_ars408_side1-msg:ClusterVrel instead.")
  (ClusterVrel m))

(cl:ensure-generic-function 'ClusterDynProp-val :lambda-list '(m))
(cl:defmethod ClusterDynProp-val ((m <radar_cluster_info>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader conti_ars408_side1-msg:ClusterDynProp-val is deprecated.  Use conti_ars408_side1-msg:ClusterDynProp instead.")
  (ClusterDynProp m))

(cl:ensure-generic-function 'ClusterRCS-val :lambda-list '(m))
(cl:defmethod ClusterRCS-val ((m <radar_cluster_info>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader conti_ars408_side1-msg:ClusterRCS-val is deprecated.  Use conti_ars408_side1-msg:ClusterRCS instead.")
  (ClusterRCS m))

(cl:ensure-generic-function 'ClusterPdh0-val :lambda-list '(m))
(cl:defmethod ClusterPdh0-val ((m <radar_cluster_info>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader conti_ars408_side1-msg:ClusterPdh0-val is deprecated.  Use conti_ars408_side1-msg:ClusterPdh0 instead.")
  (ClusterPdh0 m))

(cl:ensure-generic-function 'ClusterAmbigState-val :lambda-list '(m))
(cl:defmethod ClusterAmbigState-val ((m <radar_cluster_info>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader conti_ars408_side1-msg:ClusterAmbigState-val is deprecated.  Use conti_ars408_side1-msg:ClusterAmbigState instead.")
  (ClusterAmbigState m))
...
(cl:defmethod ClusterInvalidState-val ((m <radar_cluster_info>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader conti_ars408_side1-msg:ClusterInvalidState-val is deprecated.  Use conti_ars408_side1-msg:ClusterInvalidState instead.")
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<radar_cluster_info>)))
  ...
  "conti_ars408_side1/radar_cluster_info")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'radar_cluster_info)))
  "Returns string type for a message object of type 'radar_cluster_info"
  "conti_ars408_side1/radar_cluster_info")
