...
(cl:defclass <radar_object> (roslisp-msg-protocol:ros-message)
  ((header
   ...
   (object_info
    :reader object_info
    :initarg :object_info
    :type (cl:vector conti_ars408_side1-msg:radar_object_info)
   :initform (cl:make-array 0 :element-type 'conti_ars408_side1-msg:radar_object_info :initial-element (cl:make-instance 'conti_ars408_side1-msg:radar_object_info))))
)
...
(cl:defmethod cl:initialize-instance :after ((m <radar_object>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'radar_object)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name conti_ars408_side1-msg:<radar_object> is deprecated: use conti_ars408_side1-msg:radar_object instead.")))

(cl:ensure-generic-function 'header-val :lambda-list '(m))
(cl:defmethod header-val ((m <radar_object>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader conti_ars408_side1-msg:header-val is deprecated.  Use conti_ars408_side1-msg:header instead.")
  (header m))

(cl:ensure-generic-function 'object_info-val :lambda-list '(m))
(cl:defmethod object_info-val ((m <radar_object>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader conti_ars408_side1-msg:object_info-val is deprecated.  Use conti_ars408_side1-msg:object_info instead.")
  (object_info m))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <radar_object>) istream)
  ...
  (cl:let ((vals (cl:slot-value msg 'object_info)))
    ...
    (cl:setf (cl:aref vals i) (cl:make-instance 'conti_ars408_side1-msg:radar_object_info))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<radar_object>)))
  ...
  "conti_ars408_side1/radar_object")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'radar_object)))
  "Returns string type for a message object of type 'radar_object"
  "conti_ars408_side1/radar_object")
