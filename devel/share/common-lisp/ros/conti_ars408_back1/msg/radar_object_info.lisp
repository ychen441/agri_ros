...
(cl:defmethod cl:initialize-instance :after ((m <radar_object_info>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'radar_object_info)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name conti_ars408_back1-msg:<radar_object_info> is deprecated: use conti_ars408_back1-msg:radar_object_info instead.")))

(cl:ensure-generic-function 'ObjectID-val :lambda-list '(m))
(cl:defmethod ObjectID-val ((m <radar_object_info>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader conti_ars408_back1-msg:ObjectID-val is deprecated.  Use conti_ars408_back1-msg:ObjectID instead.")
  (ObjectID m))

(cl:ensure-generic-function 'ObjectPosn-val :lambda-list '(m))
(cl:defmethod ObjectPosn-val ((m <radar_object_info>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader conti_ars408_back1-msg:ObjectPosn-val is deprecated.  Use conti_ars408_back1-msg:ObjectPosn instead.")
  (ObjectPosn m))

(cl:ensure-generic-function 'ObjectVrel-val :lambda-list '(m))
(cl:defmethod ObjectVrel-val ((m <radar_object_info>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader conti_ars408_back1-msg:ObjectVrel-val is deprecated.  Use conti_ars408_back1-msg:ObjectVrel instead.")
  (ObjectVrel m))

(cl:ensure-generic-function 'ObjectArel-val :lambda-list '(m))
(cl:defmethod ObjectArel-val ((m <radar_object_info>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader conti_ars408_back1-msg:ObjectArel-val is deprecated.  Use conti_ars408_back1-msg:ObjectArel instead.")
  (ObjectArel m))

(cl:ensure-generic-function 'ObjectDynProp-val :lambda-list '(m))
(cl:defmethod ObjectDynProp-val ((m <radar_object_info>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader conti_ars408_back1-msg:ObjectDynProp-val is deprecated.  Use conti_ars408_back1-msg:ObjectDynProp instead.")
  (ObjectDynProp m))

(cl:ensure-generic-function 'ObjectRCS-val :lambda-list '(m))
(cl:defmethod ObjectRCS-val ((m <radar_object_info>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader conti_ars408_back1-msg:ObjectRCS-val is deprecated.  Use conti_ars408_back1-msg:ObjectRCS instead.")
  (ObjectRCS m))

(cl:ensure-generic-function 'ObjectMeasState-val :lambda-list '(m))
(cl:defmethod ObjectMeasState-val ((m <radar_object_info>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader conti_ars408_back1-msg:ObjectMeasState-val is deprecated.  Use conti_ars408_back1-msg:ObjectMeasState instead.")
  (ObjectMeasState m))

(cl:ensure-generic-function 'ObjectProbOfExist-val :lambda-list '(m))
(cl:defmethod ObjectProbOfExist-val ((m <radar_object_info>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader conti_ars408_back1-msg:ObjectProbOfExist-val is deprecated.  Use conti_ars408_back1-msg:ObjectProbOfExist instead.")
  (ObjectProbOfExist m))

(cl:ensure-generic-function 'ObjectClass-val :lambda-list '(m))
(cl:defmethod ObjectClass-val ((m <radar_object_info>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader conti_ars408_back1-msg:ObjectClass-val is deprecated.  Use conti_ars408_back1-msg:ObjectClass instead.")
  (ObjectClass m))
...
(cl:defmethod ObjectOrientationAngle-val ((m <radar_object_info>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader conti_ars408_back1-msg:ObjectOrientationAngle-val is deprecated.  Use conti_ars408_back1-msg:ObjectOrientationAngle instead.")
...
(cl:defmethod ObjectLength-val ((m <radar_object_info>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader conti_ars408_back1-msg:ObjectLength-val is deprecated.  Use conti_ars408_back1-msg:ObjectLength instead.")
  (ObjectLength m))

(cl:ensure-generic-function 'ObjectWidth-val :lambda-list '(m))
(cl:defmethod ObjectWidth-val ((m <radar_object_info>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader conti_ars408_back1-msg:ObjectWidth-val is deprecated.  Use conti_ars408_back1-msg:ObjectWidth instead.")
  (ObjectWidth m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<radar_object_info>)))
  ...
  "conti_ars408_back1/radar_object_info")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'radar_object_info)))
  "Returns string type for a message object of type 'radar_object_info"
  "conti_ars408_back1/radar_object_info")
