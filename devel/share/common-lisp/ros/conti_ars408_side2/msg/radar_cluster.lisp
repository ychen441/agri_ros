...
(cl:defclass <radar_cluster> (roslisp-msg-protocol:ros-message)
  ((header
   ...
   (cluster_info
    ...
    :type (cl:vector conti_ars408_side2-msg:radar_cluster_info)
   :initform (cl:make-array 0 :element-type 'conti_ars408_side2-msg:radar_cluster_info :initial-element (cl:make-instance 'conti_ars408_side2-msg:radar_cluster_info))))
)
...
(cl:defmethod cl:initialize-instance :after ((m <radar_cluster>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'radar_cluster)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name conti_ars408_side2-msg:<radar_cluster> is deprecated: use conti_ars408_side2-msg:radar_cluster instead.")))

(cl:ensure-generic-function 'header-val :lambda-list '(m))
(cl:defmethod header-val ((m <radar_cluster>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader conti_ars408_side2-msg:header-val is deprecated.  Use conti_ars408_side2-msg:header instead.")
  (header m))

(cl:ensure-generic-function 'cluster_info-val :lambda-list '(m))
(cl:defmethod cluster_info-val ((m <radar_cluster>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader conti_ars408_side2-msg:cluster_info-val is deprecated.  Use conti_ars408_side2-msg:cluster_info instead.")
  (cluster_info m))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <radar_cluster>) istream)
  ...
  (cl:let ((vals (cl:slot-value msg 'cluster_info)))
    ...
    (cl:setf (cl:aref vals i) (cl:make-instance 'conti_ars408_side2-msg:radar_cluster_info))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<radar_cluster>)))
  ...
  "conti_ars408_side2/radar_cluster")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'radar_cluster)))
  "Returns string type for a message object of type 'radar_cluster"
  "conti_ars408_side2/radar_cluster")
