...
namespace conti_ars408_side2{
    ...
    conti_ars408_side2::object_ROS::object_ROS(ros::NodeHandle &nh, conti_ars408_side2::CONTI_ARS408_CAN *conti_ars408_can):
        conti_ars408_can_(conti_ars408_can){
            ...
            object_ROS_pub_ = nh.advertise<conti_ars408_side2::radar_object>("conti_ars408_side2/object_ROS", 10);
        }

    conti_ars408_side2::object_ROS::~object_ROS(){}

    void conti_ars408_side2::object_ROS::set_frame_id(std::string frame_id){

        frame_id_ = std::move(frame_id);
    }

    void conti_ars408_side2::object_ROS::send_ObjectStatus(){
    ...
    void conti_ars408_side2::object_ROS::send_ObjectGeneral(){
    ...
    void conti_ars408_side2::object_ROS::send_ObjectQuality(){
    ...
    void conti_ars408_side2::object_ROS::send_ObjectExtended(){
