...
namespace conti_ars408_side2{
    ...
    conti_ars408_side2::input_ROS::input_ROS(ros::NodeHandle &nh, conti_ars408_side2::CONTI_ARS408_CAN *conti_ars408_can): 
        conti_ars408_can_(conti_ars408_can){
            ...
            input_ROS_sub_ = nh.subscribe("input_ROS_side2", 10, &input_ROS::inputCallback, this);
        }

    conti_ars408_side2::input_ROS::~input_ROS(){}

    void conti_ars408_side2::input_ROS::inputCallback(nav_msgs::Odometry msg){
