#ifndef AGRI_SRC_CONTI_ARS408_side2_ROS_OBJECT_H_
#define AGRI_SRC_CONTI_ARS408_side2_ROS_OBJECT_H_

#include <ros/ros.h>
#include <cstdint>

#include "conti_ars408_side2/conti_ars408_sensor_object.hpp"
...
namespace conti_ars408_side2{
    ...
    class object_ROS{
        ...
        public:
         object_ROS(ros::NodeHandle &nh, conti_ars408_side2::CONTI_ARS408_CAN *conti_ars408_can);
         ~object_ROS();
        ...
        private:
         ...
         conti_ars408_side2::radar_object radar_objects;
...
#endif //AGRI_SRC_CONTI_ARS408_side2_ROS_OBJECT_H_
