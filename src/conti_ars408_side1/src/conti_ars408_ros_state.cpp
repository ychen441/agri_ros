...
namespace conti_ars408_side1{
    ...
    conti_ars408_side1::state_ROS::state_ROS(ros::NodeHandle &nh, conti_ars408_side1::CONTI_ARS408_CAN *conti_ars408_can): 
    ...
    conti_ars408_side1::state_ROS::~state_ROS(){}

    void conti_ars408_side1::state_ROS::send_RadarState(){
