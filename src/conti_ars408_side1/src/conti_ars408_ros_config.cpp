#include "conti_ars408_side1/conti_ars408_ros_config.hpp"

namespace conti_ars408_side1{

    conti_ars408_side1::config_ROS::config_ROS(ros::NodeHandle &nh, conti_ars408_side1::CONTI_ARS408_CAN *conti_ars408_can): 
        ...
        conti_ars408_side1::config_ROS::~config_ROS(){}

        bool conti_ars408_side1::config_ROS::set_MaxDistance(
        ...
        bool conti_ars408_side1::config_ROS::set_SensorID(
        ...
        bool conti_ars408_side1::config_ROS::set_RadarPower(
        ...
        bool conti_ars408_side1::config_ROS::set_OutputType(
        ...
        bool conti_ars408_side1::config_ROS::set_SendQuality(
        ...
        bool conti_ars408_side1::config_ROS::set_SendExtInfo(
        ...
        bool conti_ars408_side1::config_ROS::set_SortIndex(
        ...
        bool conti_ars408_side1::config_ROS::set_CtrlRelay(
        ...
        bool conti_ars408_side1::config_ROS::set_StoreInNVM(
        ...
        bool conti_ars408_side1::config_ROS::set_RCSThreshold(
