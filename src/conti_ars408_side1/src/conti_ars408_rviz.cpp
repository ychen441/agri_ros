...
#include "conti_ars408_side1/radar_cluster.h"
#include "conti_ars408_side1/radar_object.h"
#include "conti_ars408_side1/conti_ars408_rviz.hpp"

namespace conti_ars408_side1{

    conti_ars408_side1::conti_ars408_RViz::conti_ars408_RViz(){
        ...
        cluster_RViz_pub_ = nh.advertise<visualization_msgs::Marker>("cluster_RViz_side1", 50);
        object_RViz_pub_ = nh.advertise<visualization_msgs::Marker>("object_RViz_side1", 50);
        velocity_RViz_pub_ = nh.advertise<visualization_msgs::Marker>("velocity_RViz_side1", 50);
        
        /*Subscribe cluster_ROS and object_ROS.nodes with clusters and objs info, perspectively*/
        cluster_RViz_sub_ = nh.subscribe("conti_ars408_side1/cluster_ROS", 50, &conti_ars408_RViz::cluster_RViz, this);
        object_RViz_sub_ = nh.subscribe("conti_ars408_side1/object_ROS", 50, &conti_ars408_RViz::object_RViz, this);
    }

    conti_ars408_side1::conti_ars408_RViz::~conti_ars408_RViz(){}

    void conti_ars408_side1::conti_ars408_RViz::cluster_RViz(conti_ars408_side1::radar_cluster radar_clusters){
    ...
    void conti_ars408_side1::conti_ars408_RViz::object_RViz(conti_ars408_side1::radar_object radar_objects){
