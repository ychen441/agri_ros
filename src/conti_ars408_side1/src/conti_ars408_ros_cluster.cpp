...
#include <string>
#include <vector>
#include <conti_ars408_side1/conti_ars408_ros_cluster.hpp>

namespace conti_ars408_side1{

    conti_ars408_side1::cluster_ROS::cluster_ROS(ros::NodeHandle &nh, conti_ars408_side1::CONTI_ARS408_CAN *conti_ars408_can):
        cluster_id_(0), conti_ars408_can_(conti_ars408_can){
            ...
            cluster_ROS_pub_ = nh.advertise<conti_ars408_side1::radar_cluster>("conti_ars408_side1/cluster_ROS", 10);
        }

    conti_ars408_side1::cluster_ROS::~cluster_ROS(){}

    void conti_ars408_side1::cluster_ROS::set_frame_id(std::string frame_id){

        frame_id_ = std::move(frame_id);
    }

    void conti_ars408_side1::cluster_ROS::send_ClusterStatus(){
    ...
    void conti_ars408_side1::cluster_ROS::send_ClusterGeneral(){
    ...
    void conti_ars408_side1::cluster_ROS::send_ClusterQuality(){
