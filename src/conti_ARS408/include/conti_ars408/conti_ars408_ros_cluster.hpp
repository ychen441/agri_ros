#ifndef AGRI_SRC_CONTI_ARS408_ROS_CLUSTER_H_
#define AGRI_SRC_CONTI_ARS408_ROS_CLUSTER_H_
...
namespace conti_ars408{
    ...
    class cluster_ROS{
        ...
        public:
         cluster_ROS(ros::NodeHandle &nh, conti_ars408::CONTI_ARS408_CAN *conti_ars408_can);
         ~cluster_ROS();
        ...
        private:
         ...
         conti_ars408::radar_cluster radar_clusters;
...
#endif //AGRI_SRC_CONTI_ARS408_ROS_CLUSTER_H_