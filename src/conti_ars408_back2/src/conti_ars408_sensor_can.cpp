...
namespace conti_ars408_back2{
    ...
    conti_ars408_back2::CONTI_ARS408_CAN::~CONTI_ARS408_CAN(){}
    ...
    bool CONTI_ARS408_CAN::send_CAN_messages_valid(uint32_t frame_id){
        ...
        switch(frame_id){
            ...
            case conti_ars408_back2::def_can_msgs::RadarCfg:
                can_.write(frame_id, 8, RadarCfg_.get_RadarConfig()->radar_config_raw);
            break;

            case conti_ars408_back2::def_can_msgs::SpeedInformation:
                can_.write(frame_id, 2, SpeedInfo_.get_SpeedInfo()->speed_info_raw);
            break;

            case conti_ars408_back2::def_can_msgs::YawRateInformation:
