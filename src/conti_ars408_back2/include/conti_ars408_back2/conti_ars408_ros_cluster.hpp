#ifndef AGRI_SRC_CONTI_ARS408_back2_ROS_CLUSTER_H_
#define AGRI_SRC_CONTI_ARS408_back2_ROS_CLUSTER_H_

#include <ros/ros.h>
#include <cstdint>

#include "conti_ars408_back2/conti_ars408_sensor_cluster.hpp"
...
namespace conti_ars408_back2{
    ...
    class cluster_ROS{
        ...
        public:
         cluster_ROS(ros::NodeHandle &nh, conti_ars408_back2::CONTI_ARS408_CAN *conti_ars408_can);
         ~cluster_ROS();
        ...
        private:
         ...
         conti_ars408_back2::radar_cluster radar_clusters;
...
#endif //AGRI_SRC_CONTI_ARS408_back2_ROS_CLUSTER_H_