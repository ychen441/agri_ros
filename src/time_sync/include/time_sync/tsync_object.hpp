...
namespace time_sync{
        ...
        ros::Publisher radar_object_pub_side2;

        ros::Publisher radar_object_pub_back1;

        ros::Publisher radar_object_pub_back2;
        ...
        message_filters::Subscriber<visualization_msgs::Marker> radar_object_sub_side2;

        message_filters::Subscriber<visualization_msgs::Marker> radar_object_sub_back1;

        message_filters::Subscriber<visualization_msgs::Marker> radar_object_sub_back2;
        ...
        typedef message_filters::sync_policies::ApproximateTime<
            ...
            visualization_msgs::Marker, visualization_msgs::Marker, 
            sensor_msgs::PointCloud2> tsync_object_policy;
